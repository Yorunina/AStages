...
@NotNullParams
public class RequestClientStagesS2C implements AStagesPacket {
    private final AStageSource requester;
    private final AStageSource askedFor;
    private final UUID requesterUUID;
    private final UUID playerUUID;

    public RequestClientStagesS2C(AStageSource requester, AStageSource askedFor, @Nullable UUID requesterUUID, @Nullable UUID playerUUID) {
    ...
    public RequestClientStagesS2C(FriendlyByteBuf buf) {
