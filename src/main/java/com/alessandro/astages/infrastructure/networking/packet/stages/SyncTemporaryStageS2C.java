...
@NotNullParams
public class SyncTemporaryStageS2C implements AStagesPacket {
    private final String stageKey;
    private final ItemStack stack;

    public SyncTemporaryStageS2C(String stageKey, @Nullable ItemStack stack) {
        this.stageKey = stageKey;
        this.stack = stack;
    }

    public SyncTemporaryStageS2C(FriendlyByteBuf buf) {
